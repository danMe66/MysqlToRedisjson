...
JAVA_OUT=/home/app/www/logs/${APP_NAME}/${time}_start.log  #应用的启动日志

# 创建出相关目录
mkdir -p ${HEALTH_CHECK_FILE_DIR}
mkdir -p ${APP_HOME}
mkdir -p /home/app/www/logs/${APP_NAME}
usage() {
...
start_application() {
    ...
    nohup java -jar ${JAR_NAME} -spring.profiles.active=pord > ${JAVA_OUT} 2>&1 &
